...
def shift_led_data(data, shift_amount=6): # The beginning of the LED strip is not at sensor 1, so we need to shift the data (binaries). The data is also reversed.
